...
String[] terms = {"Terms and Conditions", "Dear "+userDB.FirstName, "thanks for banking with us.",
...
BPanel.setBounds(0,85,500,650);
    ...
    BPanel.setBackground(homePage.color1);
    BPanel.add(back);
    BPanel.add(amount);
...
if (userDB.balance >= 0.0 && userDB.balance <=2000) {
  userDB.balance = userDB.balance + 1000;
}
if (userDB.balance >= 2000 && userDB.balance <=5000) {
  userDB.balance = userDB.balance + 3000;
}
if (userDB.balance >= 5000 && userDB.balance<=10000) {
  userDB.balance = userDB.balance + 7500;
}
if (userDB.balance >= 10000 && userDB.balance <=50000){
  userDB.balance = userDB.balance + 15000;
}
if (userDB.balance >= 50000 && userDB.balance<=200000){
  userDB.balance = userDB.balance + 75000;
}
if (userDB.balance >=200000){
  userDB.balance = userDB.balance + 100000;
}
...
private void showBalance(String balanceString) {
  ...
  public void actionPerformed(ActionEvent e) {
    ...
    if (e.getSource()==viewTerms) {
      ...
      labePanel.setText("Hello "+ userDB.FirstName + " here are the");
