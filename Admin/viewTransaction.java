...
Message.setBounds(130,0,500,30);
Message.setFont(new Font(null, Font.ITALIC,20));
Message.setText("View Transaction Information");
    ...
    if (!ID.getText().isEmpty() ){
      ...
      if (pass.equals(pin)) {
        int n = JOptionPane.showConfirmDialog(frame, "Are you sure you want to view this user INFORMATION ",  "Confirm", JOptionPane.YES_NO_OPTION);
          ...
          // Sql statement to retrieve the customer or employee Informations from the database
          // assign they information retrieved to this variable below
              String FirstName = "Ferdinand Love's Teju";
              double amount = 100;
              String tType = "transfer";
              String tdate = "forever";
