...
public class CustomerDetails implements ActionListener {
  ...
  JTable table = new JTable();
    ...
    JLabel userID = new JLabel("Customer Account Number");
    ...
    String pass;
    Object[] column = {"ID","FirstName" ,"LastName","DateOfBirth","Gender","ContactNumber","Address","Email"};
...
Message.setText("View Customer Information");
      ...
      if (pass.equals(pin)) {
        int n = JOptionPane.showConfirmDialog(frame, "Are you sure you want to view this user INFORMATION ",  "Confirm", JOptionPane.YES_NO_OPTION);
          ...
          // assign they information retrieved to this variable below
              ...
              String DateOfBirth = "forever";
              String Gender = "male";
              String ContactNumber = "07062764232";
              String Address = "When you want to";
