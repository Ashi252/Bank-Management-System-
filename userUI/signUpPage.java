...
// working on the text fields and their titles
        firstNameMiddleName.setBounds(125,105,140,20);
        textField.setBounds(125,125,230,20);

        lastName.setBounds(125,145,75,20);
        textField1.setBounds(125,165,230,20);

        phone.setBounds(125,185,75,20);
        textField2.setBounds(125,205,230,20);

        Address.setBounds(125,225,75,20);
        AddressField.setBounds(125,245,230,20);


        Email.setBounds(125,265,75,20);
        EmailField.setBounds(125,285,230,20);


        password.setBounds(125,305,75,20);
        passwordField.setBounds(125,325,230,20);

        CPassword.setBounds(125,345,140,20);
        Confirm.setBounds(125,365,230,20);
...
// working on the massage label
        Massage.setBounds(125,90,250,25);
...
//                bar.setString("Waiting...");
                JOptionPane.showMessageDialog(frame, "Account created successfully, Please login ", "Required", JOptionPane.PLAIN_MESSAGE);
                frame.dispose();
                new login();
            }
