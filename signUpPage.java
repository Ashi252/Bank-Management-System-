    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(terms.isSelected() &&  e.getSource()== signUP){
            ...
            if (Massage.getText().equals("Sign up successful. Redirecting to login page...")) {
                ...
                String statement = String.format("insert into customer(fistName, lastName, dob, gender, contactNumber, password) values('%s', '%s', '%s', '%s', '%s', '%s') ", firstName, lastname, dob, Gender, phoneNum, password);
                new SqlStatements().insert(statement);
        ...
        if(!validateNames(textField.getText()) || !validateNames(textField1.getText()) ){
            Massage.setText("Names should be 3 letters or more");
            Massage.setForeground(Color.RED);
        }else if(!validatePhone(textField2.getText()))
        {
            Massage.setText("Phone no should be of format 080.....");
            Massage.setForeground(Color.RED);
        }
