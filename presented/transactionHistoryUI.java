...
public class transactionHistoryUI implements ActionListener {
    ...
    Object[] column = {"Name","Amount","Transaction Type","Date", "receiver"};
    DefaultTableModel model = new DefaultTableModel();
    User user;

    public transactionHistoryUI(User user){
        this.user = user;
...
//        rows[3] = tdate;
        ...
        ArrayList<Object[]> transArray = user.createTransaction();
    ...
    public static void main(String[] args) {
        new transactionHistoryUI(new User());
    }
    @Override
